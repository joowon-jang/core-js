...
let calculateTotal = function () {
  // 함수 안에서만 접근 가능한 인수들의 집합 객체로서 배열과 유사하여 유사배열 이라 불리는 지역 변수 (arguments)
  // arguments는 iterable
...
// anonymousFunctionExpression.name => anonymousFunctionExpression
...
// <div>tiger : 40</div><div>beom : 45</div>
